    ...
    <div className="min-h-screen bg-maru-cloud py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          <h1 className="text-4xl font-bold text-maru-navy mb-4">Refund Policy</h1>
          <p className="text-maru-grey mb-8">Last updated: January 2026</p>

          <div className="prose prose-gray max-w-none">
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">General Policy</h2>
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Subscription Refunds</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Exceptions</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">How to Request a Refund</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Cooling-off Period (South Africa)</h2>
            <p className="text-maru-grey mb-4">
            ...
            <p className="text-maru-grey mb-4">
              If you have questions about this policy, please contact us at <a href="mailto:support@maruonline.com" className="text-maru-blue-700 hover:text-maru-blue-700">support@maruonline.com</a>.
            </p>
          </div>
