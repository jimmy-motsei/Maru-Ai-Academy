    ...
    <div className="min-h-screen bg-maru-cloud py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          <h1 className="text-4xl font-bold text-maru-navy mb-4">Terms of Service</h1>
          <p className="text-maru-grey mb-8">Last updated: December 2024</p>

          <div className="prose prose-gray max-w-none">
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Agreement to Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Use License</h2>
            <p className="text-maru-grey mb-4">
            ...
            <ul className="list-disc pl-6 text-maru-grey mb-4 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">User Accounts</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Subscriptions and Payments</h2>
            <h3 className="text-xl font-semibold text-maru-navy mt-6 mb-3">Billing</h3>
            <p className="text-maru-grey mb-4">
            ...
            <h3 className="text-xl font-semibold text-maru-navy mt-6 mb-3">Cancellation</h3>
            <p className="text-maru-grey mb-4">
            ...
            <h3 className="text-xl font-semibold text-maru-navy mt-6 mb-3">Changes to Fees</h3>
            <p className="text-maru-grey mb-4">
              We reserve the right to modify subscription fees. We will provide you with reasonable notice of any fee
              changes before they take effect.
            </p>

            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Content Ownership</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">User Conduct</h2>
            <p className="text-maru-grey mb-4">
              You agree not to:
            </p>
            <ul className="list-disc pl-6 text-maru-grey mb-4 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Termination</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Limitation of Liability</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Disclaimer</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Governing Law</h2>
            <p className="text-maru-grey mb-4">
              These Terms shall be governed by and construed in accordance with the laws of South Africa, without regard
              to its conflict of law provisions.
            </p>

            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Changes to Terms</h2>
            <p className="text-maru-grey mb-4">
            ...
            <h2 className="text-2xl font-bold text-maru-navy mt-8 mb-4">Contact Information</h2>
            <p className="text-maru-grey mb-4">
              If you have any questions about these Terms, please contact us:
            </p>
            <ul className="list-none text-maru-grey mb-4 space-y-2">
              <li>Email: <a href="mailto:support@maruonline.com" className="text-maru-blue-700 hover:text-maru-blue-700">support@maruonline.com</a></li>
              <li>Website: <Link href="/contact" className="text-maru-blue-700 hover:text-maru-blue-700">Contact Form</Link></li>
            </ul>
          </div>

          <div className="mt-12 pt-6 border-t border-maru-line">
            <Link href="/" className="text-maru-blue-700 hover:text-maru-blue-700 font-semibold">
              ← Back to Home
            </Link>
          </div>
        </div>
